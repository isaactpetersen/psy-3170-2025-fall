...
You are expected to do the readings before class.
You will have an online quiz on the readings to complete in [ICON](https://icon.uiowa.edu), on your own, <u>before</u> each lecture.
...
The league will be a head-to-head league, meaning that each week, your team will face one other team, and whoever scores more points wins that week.
There are no points based on performance (i.e., you will NOT be punished for having a bad team); however, there is an [extra credit opportunity](#extraCredit) for winning the league.
...
In conjunction with your co-manager, you will make decisions regarding draft picks, waiver wire pickups/drops, trades, and starting lineups.
Regardless of your expertise or experience with fantasy football, you are a 50% co-owner of the team.
That is, <u>you are expected to make all team-related decisions in collaboration with your co-manager</u>, not unilaterally.
...
- trading players, not on bye week, just so an opponent can specifically beat another opponent and then trading back immediately
