...
1. Think critically and empirically about human behavior and performance
  ...
  - Provide well-reasoned guidance for decision-making in conditions of uncertainty.
  - Describe ways that human judgment and decision making tends to be flawed, including common heuristics and cognitive biases and how to mitigate them analytically.
  - Engage in critical thinking about causality, including devising plausible alternative explanations for observed effects.
  - Apply key concepts in causal inference including confounding, causal pathways, and counterfactuals.
  - Describe the strengths and weaknesses of humans versus computers in prediction scenarios.
1. Make sense of big data
  - Apply basic skills in statistical programming using `R` to manipulate and summarize large datasets.
1. Use, evaluate, and interpret statistical analyses
  - Apply basic skills in statistical programming using `R` to conduct data analyses.
...
1. Communicate data-driven insights effectively
