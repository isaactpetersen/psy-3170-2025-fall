...
I will give you 0.5 point extra credit if you 1) identify a new (i.e., not previously known) issue in the [course textbook](https://isaactpetersen.github.io/Fantasy-Football-Analytics-Textbook) that needs to be fixed or 2) make a <u>specific</u> suggestion for a way to improve the [textbook](https://isaactpetersen.github.io/Fantasy-Football-Analytics-Textbook) and its usefulness to you or other students.
For instance, to identify an issue that needs to be addressed, you could identify a typo, misspelling, grammatical issue, failed cross-reference link to another section of the book, or (gasp), a mistake/error.
If I have a placeholder for something in the book (e.g., a comment in brackets to insert something), I am already aware of this, and this would not count as a "new issue."
