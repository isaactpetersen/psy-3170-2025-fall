...
Use of AI in this course is permitted for the [writing assignments](#blogArticles) under three conditions:

1. You disclose how you use it
1. You begin the conversation with the [required prompt](#aiPrompt)
1. You submit the full transcript of your AI interaction along with the assignment
...
### Initial Prompt to Use {#aiPrompt}
